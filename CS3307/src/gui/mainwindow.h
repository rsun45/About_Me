...
public:
    ...
    int loadFilePath(string path);
    int saveFilePath(string path);
...
private slots:
    ...
    void on_teach_normal_mode_button_clicked();

    void on_teach_multi_mode_button_clicked();

    void on_pub_normal_mode_button_clicked();

    void on_pub_multi_mode_button_clicked();

    void on_pres_normal_mode_button_clicked();

    void on_pres_multi_mode_button_clicked();

    void on_fund_normal_mode_button_clicked();

    void on_fund_multi_mode_button_clicked();

    void on_teach_clear_all_Button_clicked();

    void on_teach_plot_graph_Button_clicked();

    void on_pub_clear_all_Button_clicked();

    void on_pub_plot_graph_Button_clicked();

    void on_pres_clear_all_Button_clicked();

    void on_pres_plot_graph_Button_clicked();

    void on_fund_clear_all_Button_clicked();

    void on_fund_plot_graph_Button_clicked();

    void on_teach_search_currentIndexChanged(int index);

    void on_pub_search_currentIndexChanged(int index);

    void on_pres_search_currentIndexChanged(int index);

    void on_fund_search_currentIndexChanged(int index);

    void on_teach_search_term_textEdited(const QString &arg1);

    void on_pub_search_term_textEdited(const QString &arg1);

    void on_pres_search_term_textEdited(const QString &arg1);

    void on_fund_search_term_textEdited(const QString &arg1);

    void on_teach_search_button_clicked();

    void on_pub_search_button_clicked();

    void on_pres_search_button_clicked();

    void on_fund_search_button_clicked();

    void on_refreshFundButton_clicked();

    void on_refreshPresentationButton_clicked();

    void on_refreshPublicationsButton_clicked();

    void on_refreshTEACHButton_clicked();
...
private:
    ...
    int teachSearchIndex, pubSearchIndex, presSearchIndex, fundSearchIndex;
    std::string teachSearchTerm, pubSearchTerm, presSearchTerm, fundSearchTerm;
    ...
    // this variable use to store multi-selected values
    std::vector<std::pair <std::string, double>> teach_multi_chartList;
    std::vector<std::pair <std::string, double>> pub_multi_chartList;
    std::vector<std::pair <std::string, double>> pres_multi_chartList;
    std::vector<std::pair <std::string, double>> fund_multi_chartList;
    // store name list
    QVector<QString> teach_nameList;
    QVector<QString> pub_nameList;
    QVector<QString> pres_nameList;
    QVector<QString> fund_nameList;
    // this bool value use to test qtbutton is down
    bool isTeachNormalSelected = true;
    bool isPubNormalSelected = true;
    bool isPresNormalSelected = true;
    bool isFundNormalSelected = true;
    ...
    void setupScatterChart(QCustomPlot *scatterChart, std::vector<std::pair<std::string, double> > scatterChartList);
