 ...
 */
std::vector<BasicRecord*> RecordsManager::findRecordsInRange(int startYear, int endYear, int index, std::string compare) {
    std::vector<BasicRecord*> returnList;
    ...
    if(!compare.empty()){
        for (Manager::iterator itr = startPoint; itr != endPoint; itr++) {
            std::string temp = (*itr->second)[index];
            if(temp.find(compare) != std::string::npos){
                returnList.push_back(itr->second);
            }
        }
    }
 ...
 *                      of a TreeModel
 */
QString RecordsManager::createQStringForGrants(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, int fundSearchIndex, std::string fundSearchTerm) {
    QString s = QString(analyze(startYear, endYear, sortFields, list(1, "Total Amount"), 0x1, sortFields.back(), filterStart, filterEnd, fundSearchIndex, fundSearchTerm).c_str());
    return s;
}
 ...
 *                      of a TreeModel
 */
QString RecordsManager::createQStringForPres(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, int presSearchIndex, std::string presSearchTerm) {
    return QString(analyze(startYear, endYear, sortFields, sortFields.back(), filterStart, filterEnd, presSearchIndex, presSearchTerm).c_str());
}
 ...
 *                      of a TreeModel
 */
QString RecordsManager::createQStringForPubs(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd, int pubSearchIndex, std::string pubSearchTerm) {
    return QString(analyze(startYear, endYear, sortFields, sortFields.back(), filterStart, filterEnd, pubSearchIndex, pubSearchTerm).c_str());
}
 ...
 *                      of a TreeModel
 */
QString RecordsManager::createQStringForTeaching(int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd,  int teachSearchIndex, std::string teachSearchTerm) {
    return QString(analyze(startYear, endYear, sortFields, list(2, "Total Hours", "Number Of Trainees"), 0x0, sortFields.back(), filterStart, filterEnd, teachSearchIndex, teachSearchTerm).c_str());
}
 ...
 */
std::vector<std::pair<std::string, int>> RecordsManager::getCountByName(int startYear, int endYear, char filterStart, char filterEnd, int searchIndex, std::string searchTerm) {
    std::vector<std::pair < std::string, int>> ret;

    // query the database
    std::string query = analyze(startYear, endYear, list(1, "Member Name"), list(0), 0, "Member Name", filterStart, filterEnd, searchIndex, searchTerm);
 ...
 */
std::vector<std::pair<std::string, int>> RecordsManager::getCountTuple(int startYear, int endYear, const std::vector<std::string> &headers, const std::vector<std::string> &matchStrings, char filterStart, char filterEnd, int searchIndex, std::string searchTerm) {
    std::vector<std::pair < std::string, int>> ret;

    // query the database
    std::string query = analyze(startYear, endYear, headers, headers.back(), filterStart, filterEnd, searchIndex, searchTerm);
 ...
 */
std::vector<std::pair<std::string, double>> RecordsManager::getTotalsTuple(int startYear, int endYear, const std::vector<std::string> &headers, const std::vector<std::string> &matchStrings, std::string accCol, char filterStart, char filterEnd, int searchIndex, std::string searchTerm) {
    std::vector<std::pair < std::string, double>> ret;

    // query the database
    std::string query = analyze(startYear, endYear, headers, list(1, accCol.c_str()), 0x0, headers.back(), filterStart, filterEnd, searchIndex, searchTerm);
 ...
 */
std::string RecordsManager::analyze(int startYear, int endYear, const std::vector<std::string> &sortFields, std::string countCol, char filterStart, char filterEnd, int searchIndex, std::string searchTerm) {
    return analyze(startYear, endYear, sortFields, list(0), 0, countCol, filterStart, filterEnd, searchIndex, searchTerm);
}
...
std::string RecordsManager::analyze(int startYear, int endYear, const std::vector<std::string> &sortFields, const std::vector<std::string> &accs,
        int currencyMask, std::string countCol, char filterStart, char filterEnd, int searchIndex, std::string searchTerm) {
    std::string ret;
    int sum = 0;
    std::vector<BasicRecord*> records= findRecordsInRange(startYear, endYear, searchIndex, searchTerm);
    int m, n;
